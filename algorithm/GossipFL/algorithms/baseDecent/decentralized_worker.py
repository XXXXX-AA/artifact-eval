...
class BaseDecentralizedWorker(object):
    def __init__(self, worker_index, topology_manager, train_data_global, test_data_global, train_data_num,
        ...
        # logging.info(f"self.in_neighbor_idx_list {self.in_neighbor_idx_list}")
        ...
        # Initialize train_local_iter
        self.train_local_iter = iter(self.train_local)  # NOTE: comment translated from Chinese
    ...
    def check_whether_all_receive(self):
        # logging.info(f"{self.worker_index} check_whether_all_receive {self.flag_neighbor_result_received_dict}")
        # logging.info(f"{self.worker_index} flag_neighbor_result_received_dict {self.flag_neighbor_result_received_dict}")
        # logging.info(f"{self.worker_index} in_neighbor_idx_list {self.in_neighbor_idx_list}")
        for neighbor_idx in self.in_neighbor_idx_list:
    ...
    def aggregate(self):
        ...
        for neighbor_idx in self.in_neighbor_idx_list:
            # logging.info(f"self.train_data_local_num_dict[neighbor_idx] {self.train_data_local_num_dict[neighbor_idx]} ")
            # logging.info(f"self.worker_result_dict[neighbor_idx] {self.worker_result_dict[neighbor_idx]}")
