...
class BaseDecentralizedWorker(object):
    def __init__(self, worker_index, topology_manager, train_data_global, test_data_global, train_data_num,
        ...
        # for FLOCK
        # self.worker_result_dict_for_flock = deque()
    ...
    #         logging.debug("flag_neighbor_result_received_dict_for_flock is not empty"+str(neighbor_idx))
    ...
    def train_one_step(self, epoch=None, iteration=None, tracker=None, metrics=None):
        logging.debug("baseDecent train_one_step for worker_index: {}".format(self.worker_index))
        ...
        logging.debug("baseDecent train_one_step loss: {} ".format(loss))
    ...
    def test(self, epoch, tracker, metrics):
        ...
        logging.debug("baseDecent test for worker_index: {}".format(self.worker_index))
