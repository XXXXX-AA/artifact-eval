...
class DecentralizedWorkerManager(BaseDecentralizedWorkerManager):
    def __init__(self, args, comm, rank, size, worker, topology_manager, model_trainer, timer, metrics):
        ...
        self.tx_peer_credit_init = int(getattr(args, "tx_peer_credit", 1))
        self.tx_global_tokens_init = int(getattr(args, "tx_global_tokens", 3))
        self.tx_queue_maxsize = int(getattr(args, "tx_queue_maxsize", 3))
