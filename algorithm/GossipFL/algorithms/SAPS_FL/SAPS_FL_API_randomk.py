...
from .decentralized_worker_manager_randomk import DecentralizedWorkerManager
...
def FedML_SAPS_FL(process_id, worker_number, device, comm, model, train_data_num, train_data_global, test_data_global,
    ...
    logging.info("process_id = %d, worker_number = %d" % (process_id, worker_number))
    ...
    tpmgr = SAPSTopologyManager(worker_index,args=args)
