...
def load_iid_FashionMNIST(dataset, data_dir, partition_method,
    ...
    train_dataset = FashionMNIST(root=data_dir, train=True,
                            transform=transform, download=True)

    test_dataset = FashionMNIST(root=data_dir, train=False,
                            transform=transform, download=True)
