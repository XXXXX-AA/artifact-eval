...
from .MNIST.data_loader_local import load_partition_data_mnist as load_partition_data_mnist_local
...
from .cifar10.data_loader import load_partition_data_cifar10 as load_partition_data_cifar10
from .cifar10.data_loader_local import load_partition_data_cifar10 as load_partition_data_cifar10_local
...
from .cifar100.data_loader_local import load_partition_data_cifar100 as load_partition_data_cifar100_local
...
def load_data(args, dataset_name, **kargs):
    ...
    if dataset_name == "mnist":
        if args.partition_method == 'iid':
            ...
            logging.info("load_data. dataset_name = %s, partition_method = %s", dataset_name, args.partition_method)
            # logging.info("load_data. dataset_name = %s, partition_method = %s" % dataset_name,args.partition_method)
            ...
            if args.algorithm == "DPSGD":
                train_data_num, test_data_num, train_data_global, test_data_global, \
            train_data_local_num_dict, train_data_local_dict, test_data_local_dict, \
            class_num = load_partition_data_mnist_local(args.dataset, args.data_dir, args.partition_method,
        ...
        if dataset_name == "cifar10":
            logging.info("load_data. dataset_name = %s, partition_method = %s", dataset_name, args.partition_method)
            if args.algorithm == "DPSGD":
                data_loader = load_partition_data_cifar10_local
            else:
                data_loader = load_partition_data_cifar10
        elif dataset_name == "cifar100":    
            if args.algorithm == "DPSGD":
                data_loader = load_partition_data_cifar100_local
            else:
