...
def get_dataloader(dataset, datadir, train_bs, test_bs, dataidxs=None, args=None, download=False):
    return get_dataloader_CIFAR10(datadir, train_bs, test_bs, dataidxs, args=args, download=download)
...
def get_dataloader_CIFAR10(datadir, train_bs, test_bs, dataidxs=None, args=None, download=False):
...
def load_partition_data_cifar10(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size,
    ...
    part_path = current_dir / "partitions" / str(client_number) / "cifar10_part.json"
